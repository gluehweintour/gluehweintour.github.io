window.glueh.consent = {
  cookieString: 'GLUEH-CONSENT',
  check: function () {
    var accepted = window.glueh.cookie.check(this.cookieString);
...
window.glueh.consent.accept = window.glueh.consent.accept.bind(window.glueh.consent);
